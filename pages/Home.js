    ...
    return (
        <>
            ...
            <div className={styles.container}>
                <div className={styles.block}>{/* class="hero container flex" */}
                    <div className={styles.blockLeft}>{/*class="hero-left" */}
                        ...
                        <div className={`${styles.mainLink} d-flex`}>{/*class="ctas flex"*/}
                            <Link href="/Contact"><a className={`${styles.contactbtn} ${styles.ctaPrimary} text-center nav-link`}>Contact Us</a></Link>
                            <Link href="/Questionnaire"><a className={`${styles.quesbtn} ${styles.ctaPrimary} text-center nav-link`}>Answer a Questionnaire</a></Link>{/*class="cta-secondary"*/}
                        </div>
                    </div>
                    <div className={styles.blockRight}>{/*class="hero-right"*/}
                        <Image src="https://abhiganesh.com/assets/happy-family.svg" height='400' width='550' alt="a happy family looking at their laptop and planning for the future" />
                    </div>
                </div>
                ...
                <div>{/*class="solutions container"*/}
                    ...
                    <div className={styles.block}>{/*class="solution flex"*/}
                        <div className={styles.blockRight}>{/*class="solution-image"*/}
                            <Image src="https://abhiganesh.com/assets/preserving-solutions.png" height='400' width='550' alt="preserving solutions" />
                        </div>
                        <div className={styles.blockLeft}>{/* class="solution-info"*/}
                ...
                <Link href="/Contact"><a className={`${styles.contactbtn} ${styles.ctaPrimary} ${styles.fixedconbtn} text-center nav-link`}>Contact Us</a></Link>
                </div>
            </div>
            <Footer />
        </>
